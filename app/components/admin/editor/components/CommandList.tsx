            ...
            <div className="flex flex-col gap-0.5 overflow-y-auto max-h-60">
                {props.items.length ? (
                    props.items.map((item: any, index: number) => (
                        <button
                            className={`flex items-center gap-3 w-full text-left px-3 py-2.5 rounded-lg transition-all duration-150 ${index === selectedIndex
                        ...
                        >
                            <div
                                className={`p-1.5 rounded-md ${index === selectedIndex
                                        ? 'bg-white/20'
                            ...
                            <div className="flex flex-col">
                                ...
                                <span
                                    className={`text-[10.5px] mt-0.5 ${index === selectedIndex ? 'text-white/70' : 'text-gray-400'
                                        }`}
                                >
                                    {item.description}
                                </span>
