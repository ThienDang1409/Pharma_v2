...
const SEO_COPY = {
  homeTitle: {
    vi: "VietAnh Instruments - Thiết bị kiểm nghiệm giá trị cao",
    en: "VietAnh Instruments - High-Value Testing Equipment",
  },
  homeDescription: {
  ...
  blogTitle: {
    vi: "Blog & Tin tức | VietAnh Instruments",
    en: "Blog & News | VietAnh Instruments",
  },
  blogDescription: {
  ...
  eventsTitle: {
    vi: "Sự kiện | VietAnh Instruments",
    en: "Events | VietAnh Instruments",
  },
  eventsDescription: {
  ...
  searchTitle: {
    vi: "Tìm kiếm | VietAnh Instruments",
    en: "Search | VietAnh Instruments",
  },
  searchDescription: {
  ...
  blogNotFoundTitle: {
    vi: "Không tìm thấy bài viết | VietAnh Instruments",
    en: "Article Not Found | VietAnh Instruments",
  },
  ...
  categoryNotFoundTitle: {
    vi: "Danh mục không tồn tại | VietAnh Instruments",
    en: "Category Not Found | VietAnh Instruments",
  },
  ...
  organizationDescription: {
    vi: "Tập đoàn Dược phẩm VietAnh Instruments - Chất lượng là trách nhiệm.",
    en: "VietAnh Instruments - Trusted provider of high-value pharmaceutical testing solutions.",
  },
} as const;
