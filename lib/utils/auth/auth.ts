 ...
 * Can accept full auth response (with user) or just token refresh response (without user)
 */
export function storeAuthData(data: { accessToken: string; refreshToken?: string; user?: AuthResponseDto['user'] | null }): void {
